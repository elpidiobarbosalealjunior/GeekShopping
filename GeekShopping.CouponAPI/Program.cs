using AutoMapper;
using GeekShopping.CouponAPI.Configuration;
...
{
    c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "Geek Shopping - Coupon API", Version = "1.0", Description = "Coupon API" });
    c.EnableAnnotations();
